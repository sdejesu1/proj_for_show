...
<main>
    <h2>Admin Insert</h2>
    <p>Here is where you can submit new data into tblUserPage (and also tblContent as a result of how the contents of the table are related)</p>
    ...
    ?>
        <div class="form-style-8">
            <h2>Submit (as an admin)!</h2>
            <form action="<?php print PHP_SELF ?>" method="post">

                <fieldset>
                    <p>
                        <label class="required" for="txtUserName">User Name</label>
                        <input type="text" id="txtUserName" name="txtUserName" value="<?php print $userName;?>" tabindex="200" required>
                    </p>
                </fieldset>
